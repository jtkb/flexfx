...
package com.javatechnics.flexfx.stage.controller;
 ...
 * {@link SceneService}. This is done to prevent uncontrolled access to the Stage object.
 * Currently the controller accepts the first SceneService that it receives but future revisions will make use of
 * {@link StageManager} objects for add security.
 */
public class StageController implements ServiceListener
{
     ...
     * {@link SceneService} are notified via this interface.
     *
